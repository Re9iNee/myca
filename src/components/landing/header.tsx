...
const Header = () => {
  return (
    <header className="absolute top-0 flex h-24 2xl:h-26 w-full max-w-360 items-center justify-between p-6 md:px-10 2xl:px-27 py-6">
      <img
        src={"/logo/myca-medium-size-logo.svg"}
        alt="medium size logo"
        className="z-2 h-10 2xl:h-13"
      />
      <SuperButton
        icon={
          <img
        ...
        className="z-2 h-13! 2xl:h-14! w-59!"
      />
    </header>
  );
};
