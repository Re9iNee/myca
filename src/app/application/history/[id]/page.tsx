    ...
    <main className="flex h-full w-full flex-col justify-between px-6">
      ...
      <div>
        <header className="flex items-center justify-between py-2.5 text-sm font-medium text-slate-500">
          <Link
            href={`/application/history?carId=${carId}`}
        ...
        <div className="flex gap-2 text-base font-medium text-slate-400">
          ...
          <hr className="h-6 w-px rounded-sm bg-slate-300" />
          <h3>
            کیلومتر:{" "}
        ...
        >
          ...
          <p className="h-50 rounded-lg bg-slate-50 p-2.5 text-sm font-normal text-slate-600">
      ...
      <div className="py-3">
        <Button
          className="text-slate-50[&_svg:not([class*='size-'])]:size-6 flex h-14 w-full gap-2 rounded-2xl bg-slate-700 p-4 text-base font-medium"
          asChild
        >
